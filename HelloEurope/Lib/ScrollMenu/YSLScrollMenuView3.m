...
@interface YSLScrollMenuView3 ()

@property (nonatomic, strong) UIView *indicatorView;

@end

@implementation YSLScrollMenuView3
...
- (void)setItemImage:(NSInteger)currentIndex{
    if(currentIndex == 0){
        [itemImage1 setImage:[UIImage imageNamed:@"mypage06_btn01_on"] forState:UIControlStateNormal];
        [itemImage2 setImage:[UIImage imageNamed:@"mypage06_btn02_off"] forState:UIControlStateNormal];
        [itemImage3 setImage:[UIImage imageNamed:@"mypage06_btn03_off"] forState:UIControlStateNormal];
    }else if(currentIndex == 1){
        [itemImage1 setImage:[UIImage imageNamed:@"mypage06_btn01_off"] forState:UIControlStateNormal];
        [itemImage2 setImage:[UIImage imageNamed:@"mypage06_btn02_on"] forState:UIControlStateNormal];
        [itemImage3 setImage:[UIImage imageNamed:@"mypage06_btn03_off"] forState:UIControlStateNormal];
    }else if(currentIndex == 2){
        [itemImage1 setImage:[UIImage imageNamed:@"mypage06_btn01_off"] forState:UIControlStateNormal];
        [itemImage2 setImage:[UIImage imageNamed:@"mypage06_btn02_off"] forState:UIControlStateNormal];
        [itemImage3 setImage:[UIImage imageNamed:@"mypage06_btn03_on"] forState:UIControlStateNormal];
    }
}
