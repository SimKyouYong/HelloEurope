...
@protocol YSLScrollMenuViewDelegate3 <NSObject>
...
@interface YSLScrollMenuView3 : UIView<UIGestureRecognizerDelegate>{
    UIButton *itemImage1;
    UIButton *itemImage2;
    UIButton *itemImage3;
    UIButton *itemImage4;
...
@property (nonatomic, weak) id <YSLScrollMenuViewDelegate3> delegate;
