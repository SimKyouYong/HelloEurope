...
@interface YSLScrollMenuView2 ()

@property (nonatomic, strong) UIView *indicatorView;

@end

@implementation YSLScrollMenuView2
...
- (void)setItemImage:(NSInteger)currentIndex{
    if(currentIndex == 0){
        [itemImage1 setImage:[UIImage imageNamed:@"mypage02_btn01_on.png"] forState:UIControlStateNormal];
        [itemImage2 setImage:[UIImage imageNamed:@"mypage02_btn02_off.png"] forState:UIControlStateNormal];
        [itemImage3 setImage:[UIImage imageNamed:@"mypage02_btn03_off.png"] forState:UIControlStateNormal];
        [itemImage4 setImage:[UIImage imageNamed:@"mypage02_btn04_off.png"] forState:UIControlStateNormal];
    }else if(currentIndex == 1){
        [itemImage1 setImage:[UIImage imageNamed:@"mypage02_btn01_off.png"] forState:UIControlStateNormal];
        [itemImage2 setImage:[UIImage imageNamed:@"mypage02_btn02_on.png"] forState:UIControlStateNormal];
        [itemImage3 setImage:[UIImage imageNamed:@"mypage02_btn03_off.png"] forState:UIControlStateNormal];
        [itemImage4 setImage:[UIImage imageNamed:@"mypage02_btn03_off.png"] forState:UIControlStateNormal];
    }else if(currentIndex == 2){
        [itemImage1 setImage:[UIImage imageNamed:@"mypage02_btn01_off.png"] forState:UIControlStateNormal];
        [itemImage2 setImage:[UIImage imageNamed:@"mypage02_btn02_off.png"] forState:UIControlStateNormal];
        [itemImage3 setImage:[UIImage imageNamed:@"mypage02_btn03_on.png"] forState:UIControlStateNormal];
        [itemImage4 setImage:[UIImage imageNamed:@"mypage02_btn04_off.png"] forState:UIControlStateNormal];
    }else if(currentIndex == 3){
        [itemImage1 setImage:[UIImage imageNamed:@"mypage02_btn01_off.png"] forState:UIControlStateNormal];
        [itemImage2 setImage:[UIImage imageNamed:@"mypage02_btn02_off.png"] forState:UIControlStateNormal];
        [itemImage3 setImage:[UIImage imageNamed:@"mypage02_btn03_off.png"] forState:UIControlStateNormal];
        [itemImage4 setImage:[UIImage imageNamed:@"mypage02_btn04_on.png"] forState:UIControlStateNormal];
    }
}
