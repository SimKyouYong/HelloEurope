...
{
    if(index == 0){
        [[NSNotificationCenter defaultCenter] postNotificationName:@"talkNotification" object:nil userInfo:nil];
    }
    if(index == 1){
        [[NSNotificationCenter defaultCenter] postNotificationName:@"audioNotification" object:nil userInfo:nil];
    }
    if(index == 2){
