...
@protocol YSLContainerViewControllerDelegate2 <NSObject>

- (void)containerViewItemIndex:(NSInteger)index currentController:(UIViewController *)controller;

@end

@interface YSLContainerViewController2 : UIViewController{
    NSString *vcScrollNum;
}

@property (nonatomic, weak) id <YSLContainerViewControllerDelegate2> delegate;
