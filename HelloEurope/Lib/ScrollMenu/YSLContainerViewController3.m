...
@interface YSLContainerViewController3 () <UIScrollViewDelegate, YSLScrollMenuViewDelegate3>

@property (nonatomic, assign) CGFloat topBarHeight;
@property (nonatomic, assign) NSInteger currentIndex;
@property (nonatomic, strong) YSLScrollMenuView3 *menuView;

@end

@implementation YSLContainerViewController3
...
- (void)viewDidLoad {
    ...
    // meunView
    _menuView = [[YSLScrollMenuView3 alloc]initWithFrame:CGRectMake(0, _topBarHeight, self.view.frame.size.width, kYSLScrollMenuViewHeight)];
