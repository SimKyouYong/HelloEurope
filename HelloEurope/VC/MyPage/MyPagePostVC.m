...
#import "MyPagePostCell.h"

@interface MyPagePostVC ()
@property (strong, nonatomic) DrawerNavigation *rootNav;
@end

@implementation MyPagePostVC
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@%@", COMMON_URL, MY_POST_URL];
...
{
    MyPagePostCell *cell = (MyPagePostCell *)[tableView dequeueReusableCellWithIdentifier:@"MyPagePostCell"];

    if (cell == nil){
        cell = [[MyPagePostCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"MyPagePostCell"];
    }
    
    NSDictionary *dic = [postArr objectAtIndex:indexPath.row];
...
- (void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName{
    ...
    if ([elementName isEqualToString:@"Key_Index"]){
        ...
        [postArr addObject:[NSDictionary dictionaryWithDictionary:xmlDic]];
    }
}
...
- (void)selectAction:(UIButton*)sender{
    ...
    NSMutableDictionary *dic = [postArr objectAtIndex:nIndex];
