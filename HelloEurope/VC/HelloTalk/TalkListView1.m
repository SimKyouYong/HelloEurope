...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView1:) name:@"talkListView1" object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView1SortChoo:) name:@"talkListView1SortChoo" object:nil];
    }
    return self;
}
