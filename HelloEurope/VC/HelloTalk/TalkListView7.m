...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView7:) name:@"talkListView7" object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView7SortChoo:) name:@"talkListView7SortChoo" object:nil];
    }
    return self;
}
