...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView3:) name:@"talkListView3" object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView3SortChoo:) name:@"talkListView3SortChoo" object:nil];
    }
    return self;
}
