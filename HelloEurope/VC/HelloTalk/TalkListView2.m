...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView2:) name:@"talkListView2" object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView2SortChoo:) name:@"talkListView2SortChoo" object:nil];
    }
    return self;
}
