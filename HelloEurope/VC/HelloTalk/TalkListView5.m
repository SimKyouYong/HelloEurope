...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView5:) name:@"talkListView5" object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView5SortChoo:) name:@"talkListView5SortChoo" object:nil];
    }
    return self;
}
