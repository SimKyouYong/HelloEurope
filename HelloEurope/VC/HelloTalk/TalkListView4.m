...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView4:) name:@"talkListView4" object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(talkListView4SortChoo:) name:@"talkListView4SortChoo" object:nil];
    }
    return self;
}
